...
document.addEventListener('DOMContentLoaded', () => {
   ...
   * list item includes a click handler that allows the user to rename that item.
   */
...
// Register the service worker when the page has fully loaded. This allows
// the application to cache its assets and function offline. If the
// registration fails we log the error to the console. Note that this
// registration is performed outside of the DOMContentLoaded listener so
// that it occurs after the page has loaded and does not block the rest
// of the script.
